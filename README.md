...
۱. فایل `OmniType-FreePTT.exe` را از بخش **[Releases](../../releases)** دانلود کنید.  
۲. فایل را اجرا کنید. یک دایره سبز رنگ مینیاتوری در گوشه پایین سمت راست صفحه ظاهر می‌شود.  
۳. در هر برنامه‌ای که می‌خواهید بنویسید (ادیتور، مرورگر، تلگرام و...)، **دکمه `Caps Lock` یا کلید انتخابی را نگه دارید**، صحبت کنید و سپس دکمه را رها کنید.
